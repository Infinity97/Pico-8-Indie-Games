...
cur_win_tick = 0
credits = {"the city is safe!", "", "art by:", "jamie chen", "sydney schiller", "",  "music by:", "davey jay belliss", "", "programmed by:", "davey jay belliss", "jessica hsieh",  "ayush surana", "mark nickerson", "sydney schiller", "", "special thanks", "joshua mccoy", "", "", "", "", "", "", "", "c'est la vie"}
